...
public class DepartmentService {
	...
	public void listOfDepartmentsWithAtLeastAcertainNumberOFEmployees(
			...
			int numEmployees) 
	{
		this.departmentDAO.getAllDepartmentsWithAtLeastACertainNumberOFEmployees(
	 ...
	 */
	public int addEmployeeToDepartment(
			String departmentId, 
			String employeeId) 
	{
		return this.departmentDAO.addEmployeeToDepartment(
