...
@WebServlet("/ViewEmployeesDetailsNotAffiliatedToADepartment")
public class ViewEmployeesDetailsNotAffiliatedToADepartment extends HttpServlet {
			...
			throws ServletException, IOException
	{
		...
		out.println("	<title>Employees Not Associated to A Department</title>");
		...
		List<Employee> employeesNotAssociatedToDepartment = new ArrayList<Employee>();
		List<String> columnLabels = new ArrayList<String>();
		this.employeeService.listOfEmployeesNotAssociatedToDepartment(columnLabels,employeesNotAssociatedToDepartment);
		...
		out.println("<tbody>");
		for (Employee employee : employeesNotAssociatedToDepartment) {
