...
public class ViewMaximumAndMinimumSalaries extends HttpServlet {
			...
			throws ServletException, IOException
	{
		...
		out.println("	<title>Minimum And Maximum Salary</title>");
		...
		out.println("			<tr>");
		out.printf("				<th style='text-align:center'>%s</th>", "Minimum Salary");
		out.printf("				<th style='text-align:center'>%s</th>", "Maximum Salary");
		out.println(			"</tr>");
		out.println("			<tr>");
		out.printf("				<td style='text-align:center'>$%,.2f</td>", minAndMAxSalary.get(0) );
		out.printf("				<td style='text-align:center'>$%,.2f</td>", minAndMAxSalary.get(1));
		out.println("			</tr>");	
		out.println("		</table>");	
